...
<select<?=$this->isVue()?'2':''?> <?=join("  ",$this->getAttr())?> style="font-size:18px;" <?if($this->isQuick()){?>size="<?=count($this->getOptions())?>"<?php }?> class="<?= $this->getClassName() ?> <?= $this->isMultiple() ? 'sumoselect ' : ($this->isSelect2() ? 'select2' : '') ?>"
